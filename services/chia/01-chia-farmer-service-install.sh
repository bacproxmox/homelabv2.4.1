...
if [[ ! -f "$CHIA_MNEMONIC_ENV" ]]; then
  echo "⚠️ $CHIA_MNEMONIC_ENV yok. v2.4.1 hedefi bunu Bootstrap secrets/env aşamasında toplamaktır."
...
DOWNLOAD_DIR="${CHIA_DB_DOWNLOAD_DIR:-/home/bacmaster/chia-db-download}"
CHIA_KEY_LABEL="${CHIA_KEY_LABEL:-}"
